...
model_path = os.path.join("cascades", "classificadorEigen.yml")
...
print("Iniciando reconhecimento facial Eigenface. Pressione 'Q' na janela de vídeo para sair...")
...
try:
    while True:
        ...
        cv2.imshow("Reconhecimento Facial Eigenface - Pressione Q para sair", imagem)
